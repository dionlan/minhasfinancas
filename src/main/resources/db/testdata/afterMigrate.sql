...
insert into lancamento (id, descricao, ano, mes, valor, id_usuario, status_lancamento, tipo_lancamento, data_cadastro) values (1, 'Fatura Vivo Celular', '2021', '12', 90.99, 1, 'REALIZADO', 'DESPESA', current_timestamp);
insert into lancamento (id, descricao, ano, mes, valor, id_usuario, status_lancamento, tipo_lancamento, data_cadastro) values (2, 'Conta de Luz', '2021', '12', 96.98, 1, 'REALIZADO', 'DESPESA', current_timestamp);
insert into lancamento (id, descricao, ano, mes, valor, id_usuario, status_lancamento, tipo_lancamento, data_cadastro) values (3, 'Conta de Água', '2021', '12', 78.88, 1, 'REALIZADO', 'DESPESA', current_timestamp);
...
insert into lancamento (id, descricao, ano, mes, valor, id_usuario, status_lancamento, tipo_lancamento, data_cadastro) values (5, 'Academia', '2021', '12', 115.55, 1, 'REALIZADO', 'DESPESA', current_timestamp);
insert into lancamento (id, descricao, ano, mes, valor, id_usuario, status_lancamento, tipo_lancamento, data_cadastro) values (6, 'Salário GDF', '2021', '12', 7000, 1, 'REALIZADO', 'RECEITA', current_timestamp);
